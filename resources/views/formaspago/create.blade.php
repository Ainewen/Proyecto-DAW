...
<div class="container">
   ...
   @endif
   <!--Vista del formulario para crear forma de pago-->
    <div class="row text-center">
		<h1 class="titulo mx-auto">Introducir una Forma de pago</h1>
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 justify-content-left bg-light">
			<br>
			<form enctype="multipart/form-data" method="POST" action="{{ route('formaspago.store') }}">
				 @csrf		
